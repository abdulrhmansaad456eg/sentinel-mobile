...
class LearningService {
  static final List<LearningTopic> _topics = [
    ...
    LearningTopic(
      id: 'encryption',
      titleKey: 'encryption',
      descriptionKey: 'Understand cryptographic protection',
      category: 'advanced',
      difficulty: 4,
      estimatedMinutes: 20,
      contentSections: [
        'Symmetric vs asymmetric encryption',
        'AES, RSA, and modern algorithms',
        'End-to-end encryption explained',
        'Key management and secure storage',
        'Encrypted messaging apps comparison',
        'File and disk encryption tools',
        'Quantum computing threats to encryption',
        'Practical encryption for daily use',
      ],
    ),
    LearningTopic(
      id: 'identity_theft',
    ...
    LearningTopic(
      ...
      titleKey: 'secure_communication',
      descriptionKey: 'Keep conversations and data private',
      category: 'advanced',
      difficulty: 3,
      estimatedMinutes: 15,
      contentSections: [
        'Encrypted email: PGP and S/MIME',
        ...
        'Vanishing messages and forensics',
      ],
    ),
    LearningTopic(
      id: 'data_backup',
    ...
    LearningTopic(
      ...
      titleKey: 'incident_response',
      descriptionKey: 'Know what to do when security incidents occur',
      category: 'advanced',
      difficulty: 3,
      estimatedMinutes: 15,
      contentSections: [
        'Recognizing security incidents',
        'First response steps: isolate and document',
